...
class CodeList21 extends CodeList implements CodeListInterface
{
	...
	protected static $es = [
		...
		'PRB' => 'Edición reencuadernada (en inglés «prebound»)',
	...
	protected static $de = [
		...
		'BLP' => 'Zweisprachiger Paralleldruck',
		'BRL' => 'Brailleausgabe',
		'BUD' => 'Budget Edition',
		'CMB' => 'Sammelband',
		...
		'ETR' => 'Leicht zu lesende Ausgabe',
		'EXP' => 'Zensierte Ausgabe',
		'FAC' => 'Faksimile',
		'FST' => 'Festschrift',
		'HRE' => 'High Readability Ausgabe',
		'ILL' => 'Illustrierte Ausgabe',
		'INT' => 'Internationale Ausgabe',
		'LTE' => 'Großdruck (Schriftgröße 14-19 pt)',
		'MCP' => 'Mikroschrift',
		'MDT' => 'Buch zum Film, Spiel etc',
		'MLL' => 'Mehrsprachige Ausgabe',
		'NED' => 'Neuausgabe',
		'NUM' => 'Limitierte und nummerierte Ausgabe',
		'PBO' => 'Paperback-Originalausgabe',
		'PRB' => 'Vorgebundene Ausgabe / Bibliotheksausgabe',
		'REV' => 'Überarbeitete Ausgabe',
		'SCH' => 'Schulausgabe',
		'SIG' => 'Signierte Ausgabe',
		'SMP' => 'Ausgabe in Einfacher Sprache',
		'SPE' => 'Sonderausgabe',
		'STU' => 'Schülerausgabe',
		'TCH' => 'Lehrerausgabe',
		'UBR' => 'Ungekürzte Ausgabe',
		'ULP' => 'Ungekürzte Ausgabe (Schriftgröße 20+ pt)',
		'UNN' => 'Limitierte Ausgabe',
		'UXP' => 'Unzensierte Originalfassung',
		'VAR' => 'Variorum-Ausgabe',
		'VOR' => 'Vorlesebücher',
	];
	...
	protected static $it = [
		...
		'PRB' => 'Edizione con nuova rilegatura',
