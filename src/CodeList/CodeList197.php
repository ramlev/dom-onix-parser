 ...
 * ONIX Code List 197
 *
 * Used with <CollectionSequenceType> <x479>
 *
...
class CodeList197 extends CodeList implements CodeListInterface
{
	...
	/**
	 * Code List 197 for es
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/es/197
	 */
	protected static $es = [
		'01' => 'Propio / Privado',
	...
	/**
	 * Code List 197 for fr
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/fr/197
	 */
	protected static $fr = [
		'01' => 'Propriétaire',
		'02' => 'Ordre du titre',
	...
	/**
	 * Code List 197 for it
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/it/197
	 */
	protected static $it = [
		'01' => 'Proprietario',
	...
	/**
	 * Code List 197 for nb
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/nb/197
	 */
	protected static $nb = [
		'01' => 'Proprietær',
		'02' => 'Tittelrekkefølge',
	...
	/**
	 * Code List 197 for tr
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/tr/197
	 */
	protected static $tr = [
		'01' => 'Özel',
		'02' => 'Başlık düzeni',
