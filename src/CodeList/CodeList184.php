...
class CodeList184 extends CodeList implements CodeListInterface
{
	...
	/**
	 * Code List 184 for es
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/es/184
	 */
	protected static $es = [
	...
	/**
	 * Code List 184 for de
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/de/184
	 */
	protected static $de = [
		'00' => 'No warning',
		'01' => 'Carries ‘CE’ logo',
	...
	/**
	 * Code List 184 for fr
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/fr/184
	 */
	protected static $fr = [
	...
	/**
	 * Code List 184 for it
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/it/184
	 */
	protected static $it = [
	...
	/**
	 * Code List 184 for nb
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/nb/184
	 */
	protected static $nb = [
		'00' => 'No warning',
		'01' => 'Carries ‘CE’ logo',
	...
	/**
	 * Code List 184 for tr
	 *
	 * @var array
	 * @see https://ns.editeur.org/onix/tr/184
	 */
	protected static $tr = [
		'00' => 'Uyarı yok',
		'01' => 'CE logosu taşır',
